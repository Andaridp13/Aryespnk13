...
$jadwal_mengajar_di_sma = mysqli_query($koneksi, "SELECT * FROM tbl_login WHERE id = 1");
$data = mysqli_fetch_array($jadwal_mengajar_di_sma);
?>
...
<html lang="en">
    <head>
        ...
        <title>Login - SMAN 25</title>
        <link href="<?= $main_url ?>asset/sb-admin/css/styles.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
        <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/image/defauld.png">

        <style>
            #bgLogin{
                background-image: url("../asset/image/gambar.jpg");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - SMA 25</h4></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                       <div class="text-muted small">Copyright &copy; SMAN 25 <?= date("Y") ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
